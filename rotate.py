...
def rotate_images_180(source_dir):
    """
    Rotate all images matching pattern 'r_cal_*.jpg' by 180 degrees.
    ...
    image_files = list(source_path.glob('l_cal_*.jpg'))
    
    if not image_files:
        print(f"No files matching 'l_cal_*.jpg' found in '{source_dir}'")
        return
